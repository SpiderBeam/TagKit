...
namespace TagKit.Markup
{
    public class TagException : Exception
    {
        ...
        public TagException() : this(null)
        {
        }

        //provided to meet the ECMA standards
        public TagException(String message) : this(message, ((Exception)null), 0, 0)
        {
        }

        //provided to meet ECMA standards
        public TagException(String message, Exception innerException) : this(message, innerException, 0, 0)
        {
        }

        //provided to meet ECMA standards
        public TagException(String message, Exception innerException, int lineNumber, int linePosition) :
            this(message, innerException, lineNumber, linePosition, null)
        {
        }

        internal TagException(String message, Exception innerException, int lineNumber, int linePosition, string sourceUri) :
            base(FormatUserMessage(message, lineNumber, linePosition), innerException)
        {
            HResult = HResults_Xml;
            _res = (message == null ? Resources.Xml_DefaultException : Resources.Xml_UserException);
        ...
        internal TagException(string res, string[] args) :
            this(res, args, null, 0, 0, null)
        { }

        internal TagException(string res, string[] args, string sourceUri) :
            this(res, args, null, 0, 0, sourceUri)
        { }

        internal TagException(string res, string arg) :
            this(res, new string[] { arg }, null, 0, 0, null)
        { }

        internal TagException(string res, string arg, string sourceUri) :
            this(res, new string[] { arg }, null, 0, 0, sourceUri)
        { }

        internal TagException(string res, String arg, ITagLineInfo lineInfo) :
            this(res, new string[] { arg }, lineInfo, null)
        { }

        internal TagException(string res, String arg, Exception innerException, ITagLineInfo lineInfo) :
            this(res, new string[] { arg }, innerException, (lineInfo == null ? 0 : lineInfo.LineNumber), (lineInfo == null ? 0 : lineInfo.LinePosition), null)
        { }

        internal TagException(string res, String arg, ITagLineInfo lineInfo, string sourceUri) :
            this(res, new string[] { arg }, lineInfo, sourceUri)
        { }

        internal TagException(string res, string[] args, ITagLineInfo lineInfo) :
            this(res, args, lineInfo, null)
        { }

        internal TagException(string res, string[] args, ITagLineInfo lineInfo, string sourceUri) :
            this(res, args, null, (lineInfo == null ? 0 : lineInfo.LineNumber), (lineInfo == null ? 0 : lineInfo.LinePosition), sourceUri)
        {
        }

        internal TagException(string res, int lineNumber, int linePosition) :
            this(res, (string[])null, null, lineNumber, linePosition)
        { }

        internal TagException(string res, string arg, int lineNumber, int linePosition) :
            this(res, new string[] { arg }, null, lineNumber, linePosition, null)
        { }
        
        internal TagException(string res, string arg, int lineNumber, int linePosition, string sourceUri) :
            this(res, new string[] { arg }, null, lineNumber, linePosition, sourceUri)
        { }

        internal TagException(string res, string[] args, int lineNumber, int linePosition) :
            this(res, args, null, lineNumber, linePosition, null)
        { }

        internal TagException(string res, string[] args, int lineNumber, int linePosition, string sourceUri) :
            this(res, args, null, lineNumber, linePosition, sourceUri)
        { }

        internal TagException(string res, string[] args, Exception innerException, int lineNumber, int linePosition) :
            this(res, args, innerException, lineNumber, linePosition, null)
        { }

        internal TagException(string res, string[] args, Exception innerException, int lineNumber, int linePosition, string sourceUri) :
        ...
        private static string FormatUserMessage(string message, int lineNumber, int linePosition)
        {
            if (message == null)
            {
                return CreateMessage(Resources.Xml_DefaultException, null, lineNumber, linePosition);
            }
            else
            {
                ...
                else
                {
                    ...
                    return CreateMessage(Resources.Xml_UserException, new string[] { message }, lineNumber, linePosition);
                }
            }
        }
        ...
        private static string CreateMessage(string res, string[] args, int lineNumber, int linePosition)
        {
            ...
            if (lineNumber == 0)
            {
                //message = Resources.Format(res, args);
            }
            ...
            else
            {
                ...
                //message = Resources.Format(res, args);
                //message = Resources.Format(Resources.Xml_MessageWithErrorPosition, message, lineNumberStr, linePositionStr);
            }
            return message;
        }
